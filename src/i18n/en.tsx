...
export const en: Messages = {
  ...
  report: {
    ...
    acquiredValue: (d, p, t) => `${d} direct + ${p} via entry date = ${t}`,
  ...
  detail: {
    ...
    acquiredProxy: (v) => `${v} (from entry date)`,
    rating: 'Rating',
    boughtAt: 'Bought at',
    series: 'Series',
    isbn: 'ISBN',
  ...
  genreNames: {
    ...
    'Kids': 'Kids',
    'LGBTQ+': 'LGBTQ+',
    'Literature Studies and Criticism': 'Literature Studies and Criticism',
    'Music': 'Music',
    'Mystery': 'Mystery',
    'Philosophy': 'Philosophy',
    'Picture Books': 'Picture Books',
    'Poetry': 'Poetry',
    'Politics, Government, Law and Public Policy': 'Politics, Government, Law and Public Policy',
    'Recent Fiction': 'Recent Fiction',
    'Reference': 'Reference',
    'Religion & Spirituality': 'Religion & Spirituality',
    'Romance': 'Romance',
    'Science & Nature': 'Science & Nature',
    'Science Fiction': 'Science Fiction',
    'Sexuality and Gender Studies': 'Sexuality and Gender Studies',
    'Sociology': 'Sociology',
